...
- **[2026/03/16]** **v0.3.2** मल्टी-Claw सपोर्ट: IronClaw, PicoClaw, ZeroClaw और CoPaw अब OpenClaw के साथ सपोर्टेड हैं। OpenRouter को LLM प्लेटफ़ॉर्म के रूप में जोड़ा गया।
